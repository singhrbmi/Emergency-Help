...
public class BusinessSocialAdapter extends RecyclerView.Adapter<BusinessSocialAdapter.MyViewHolder> {
    ...
    public BusinessSocialAdapter(Context mContext, List<Result> dataList) {
...
//        this.materialdesignicons_font = FontManager.getFontTypefaceMaterialDesignIcons(mContext, "fonts/materialdesignicons-webfont.otf");
    ...
    @Override
    public BusinessSocialAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_business_social, parent, false);
        return new BusinessSocialAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(BusinessSocialAdapter.MyViewHolder holder, final int position) {
    ...
    private void checkSubCategory(final String name, final String dist) {
        if (Utility.isOnline(mContext)) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Contants.SERVICE_BASE_URL + Contants.getAllBusinessSubCat,
